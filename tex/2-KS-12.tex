...
\begin{ex}%[Dự án 5YFXLV-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV015]%[1D3N2-2]
...
\begin{ex}%[Dự án 252CNS-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV015]%[2D1H5-1]
	\immini[thm]{Hàm số nào sau đây có đồ thị như hình vẽ?
		\choice [2]
			{$f(x)=x^3+3x+1$}
			{$f(x)=-x^3+3x-1$}
			{\True $f(x)=-x^3+3x+1$}
    ...
    \node at (0,0){\href{252CNS}{\tiny \phantom{252CNS}}};
		\end{tikzpicture}
		}
	\loigiai{
...
\begin{ex}%[Dự án 41GOMC-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV015]%[2D3N1-2]
...
\begin{ex}%[Dự án 3HE7AF-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV015]%[2H2N2-2]
...
\begin{ex}%[Dự án YYD074-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV015]%[2D1N2-2]
    ...
    \node at (T11){\href{YYD074}{\tiny \phantom{YYD074}}};
		\end{tikzpicture}
	\end{center}
...
\begin{ex}%[Dự án RPO7FZ-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV015]%[2D1H5-7]
	\immini[thm]{Cho hàm số $y=-x^3+3x-2$ có đồ thị như hình vẽ. Tâm đối xứng của đồ thị hàm số đã cho là
		\choice [2]
			{\True $J(0;-2)$}
			{$O(0;0)$}
			{$I(-2;0)$}
    ...
    %hidden: VM005
			...
			\fill (-1,-4) circle (1pt);
    \node at (0,0){\href{RPO7FZ}{\tiny \phantom{RPO7FZ}}};
		\end{tikzpicture}
		}
	\loigiai{
...
\begin{ex}%[Dự án 5I1ZC3-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV015]%[1H4N6-2]
	\immini[thm]{Cho hình hộp $ABCD.A'B'C'D'$. Xét phép chiếu song song theo phương $A'A$ lên mặt phẳng $(ABCD)$. Ảnh của đoạn thẳng $A'C'$ qua phép chiếu song song đó là
		\choice
			{đoạn thẳng $A'C$}
			{đoạn thẳng $AB$}
			{đoạn thẳng $BD$}
    ...
    \node at (0,0){\href{5I1ZC3}{\tiny \phantom{5I1ZC3}}};
		\end{tikzpicture}
		}
	\loigiai{
		\begin{center}
...
\begin{ex}%[Dự án OYM1ZO-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV015]%[1D2H1-4]
...
\begin{ex}%[Dự án 1IFPHL-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV015]%[1D6H4-3]
...
\begin{ex}%[Dự án 3AX3KL-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV015]%[2H2H1-3]
	\immini[thm]{Cho hình lập phương $ABCD.A'B'C'D'$ có cạnh bằng $1$. Tích vô hướng của hai vectơ $\overrightarrow{CC'}$ và $\overrightarrow{A'A}$ bằng
		\choice[2]
			{$0$}
			{\True $-1$}
			{$2$}
    ...
    %hidden: VM005
			...
			\draw (D)--(C)--(B)--(B')--(A')--(D')--(C')--(C) (D)--(D') (B')--(C');
			\foreach \x/\g in {A/150, B/0, C/-60, D/-135, A'/120, B'/45, C'/-15, D'/180 }{\fill (\x) circle (1pt) node[shift={(\g:7pt)}]{$\x$};}
    \node at (0,0){\href{3AX3KL}{\tiny \phantom{3AX3KL}}};
		\end{tikzpicture}
		}
	\loigiai{
...
\begin{ex}%[Dự án OF3F5U-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV015]%[2H5N1-1]
...
\begin{ex}%[Dự án 23JWA8-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV015]%[2H2H2-1]
...
\begin{ex}%[Dự án 40KPZ0-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV019]%[2D1V3-6]
    ...
    \node at (T11){\href{40KPZ0}{\tiny \phantom{40KPZ0}}};
				\end{tikzpicture}
			\end{center}
...
\begin{ex}%[Dự án 58HE7J-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV019]%[2D1H5-1]
	\immini[thm]{Cho hàm số $y=f(x)=-x-\dfrac{1}{x-1}$ có đồ thị là đường cong $(C)$.
		\choiceTF
    ...
    %hidden: VM005
				...
				\fill (0,0) node{\href{58HE7J}{\tiny \phantom{58HE7J}}} circle(1pt);
				\begin{scope}
    ...
    \node at (0,0){\href{58HE7J}{\tiny \phantom{58HE7J}}};
			\end{tikzpicture}}
	\loigiai{
		\begin{itemchoice}
    ...
    \node at (T11){\href{58HE7J}{\tiny \phantom{58HE7J}}};
				\end{tikzpicture}
			\end{center}
...
\begin{ex}%[Dự án 3XU9QE-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV034]%[2H5V2-8]
    ...
    \node at (0,0){\href{3XU9QE}{\tiny \phantom{3XU9QE}}};
		\end{tikzpicture}
	\end{center}
	\choiceTF
...
\begin{ex}%[Dự án 45A9EO-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV034]%[2D3V1-2]
...
\begin{ex}%[Dự án 3WRUJF-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV028]%[2D4V3-5]
    ...
    %hidden: VM005
			...
			\draw[dashed] plot[domain=0:12, samples=50] (\x, {f(\x)}, {h(\x)})
				...
				;
    \node at (0,0){\href{3WRUJF}{\tiny \phantom{3WRUJF}}};
		\end{tikzpicture}
	\end{center}
	\par\shortans{$160$}
	\loigiai{
...
\begin{ex}%[Dự án 68N7FV-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV028]%[2H5C2-8]
    ...
    \node at (0,0){\href{68N7FV}{\tiny \phantom{68N7FV}}};
		\end{tikzpicture}
	\end{center}
...
\begin{ex}%[Dự án 4SDEQA-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV024]%[0D2V2-3]
    ...
    %hidden: VM005
				...
				\end{scope}
    \node at (0,0){\href{4SDEQA}{\tiny \phantom{4SDEQA}}};
			\end{tikzpicture}
		\end{center}
...
\begin{ex}%[Dự án 4RABQR-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,TV024]%[1H8V6-2]
    ...
    %hidden: VM005
				...
				\fill(\p) circle(1pt) node[shift={(\g:0.25)}]{$\p$};
    \node at (0,0){\href{4RABQR}{\tiny \phantom{4RABQR}}};
			\end{tikzpicture}
		\end{center}
...
\begin{ex}%[Dự án 2KV5PS-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,VM017]%[2D1V3-6]
    ...
    \node at (T11){\href{2KV5PS}{\tiny \phantom{2KV5PS}}};
			\end{tikzpicture}
		\end{center}
...
\begin{ex}%[Dự án RKB5XW-VN-MT-15]%[2-KS-12-SoNgheAn-L1-2026,VM017]%[0D0C2-7]
