...
function getApiUrl(){
  ...
  const fallback = 'https://script.google.com/macros/s/AKfycbzZSLHoLn4maS56NRozYge0CWhkX7Sd6X_FwiiXzLBCopZTQao7JafxtWZ-AMlJikx6/exec';
  return fromConfig || fromLocal || fallback;
}
